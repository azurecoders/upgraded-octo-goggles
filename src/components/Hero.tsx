        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate__animated animate__fadeInLeft">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="w-full md:w-fit px-8 py-4 dark:bg-dark-logo-primary dark:text-dark-primary-text rounded-lg text-lg font-semibold dark:hover:bg-dark-logo-primary/90 transition-colors animate__animated animate__pulse animate__infinite">
                Get Started for Free
              </button>
              <button className="w-full md:w-fit px-8 py-4 border border-1 dark:border-[#ccc] dark:text-dark-primary-text rounded-lg text-lg font-semibold transition-colors dark:bg-dark-custom-dark-blue dark:hover:bg-dark-custom-blue">
                Learn More
              </button>
            </div>
            <div className="flex items-center gap-4 text-dark-primary-text">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full dark:bg-dark-secondary-text" />
                <div className="w-8 h-8 rounded-full dark:bg-dark-button-blue" />
                <div className="w-8 h-8 rounded-full dark:bg-dark-custom-blue" />
              </div>
          ...
          <div className="relative animate__animated animate__fadeInRight">
            <div className="dark:bg-dark-custom-dark-blue backdrop-blur-sm p-6 rounded-2xl border dark:border-neutral-700 shadow-2xl">
              <div className="space-y-4">
                <div className="h-4 w-1/3 dark:bg-dark-custom-blue-stroke rounded animate-pulse" />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="h-24 dark:bg-dark-custom-blue rounded animate-pulse" />
                  <div className="h-24 dark:bg-dark-custom-blue rounded animate-pulse" />
                  <div className="hidden md:block h-24 dark:bg-dark-custom-blue rounded animate-pulse" />
                  <div className="hidden md:block h-24 dark:bg-dark-custom-blue rounded animate-pulse" />
                </div>
                <div className="h-4 w-1/2 dark:bg-dark-custom-blue-stroke rounded animate-pulse" />
              </div>
            </div>
            {/* Decorative elements */}
