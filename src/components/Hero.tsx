...
const Hero = () => {
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br bg-light-golden-white bg-light-bg dark:from-dark-button-blue dark:via-dark-text-hover dark:to-dark-button-blue relative overflow-hidden"
    >
